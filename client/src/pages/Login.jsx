...
export default function Login() {
  ...
  return (
    <div style={{ maxWidth: '400px', margin: '4rem auto' }} className="glass-panel animate-fade-in">
      <h2 style={{ marginBottom: '1.5rem', fontWeight: 600, textAlign: 'center' }}>Login</h2>
      {error && (
      ...
      <p style={{ marginTop: '1.5rem', textAlign: 'center', fontSize: '0.9rem', color: 'var(--text-muted)' }}>
        Don't have an account? <Link to="/signup" style={{ color: '#60a5fa', textDecoration: 'none' }}>Signup</Link>
      </p>
    </div>
  );
}
